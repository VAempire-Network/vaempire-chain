...
pub struct ParsedInstructions {
    ...
    pub has_vaempire_account_instruction: bool,
}
    ...
    pub fn can_produce_evm_block(&self) -> bool {
        self.instr_evm_transaction()
            ...
            + self
                ...
                .count()
            > 0
            || self.has_vaempire_account_instruction
    }
}
    ...
    fn parse_instructions(&self) -> ParsedInstructions {
        ...
        for tx in &self.transactions {
            ...
            } in transaction.message.instructions()
            {
                ...
                {
                    has_vaempire_account_instruction = true;
                }
            }
        }
        ...
        ParsedInstructions {
            ...
            has_vaempire_account_instruction,
        }
    }
}

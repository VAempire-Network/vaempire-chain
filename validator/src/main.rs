...
pub fn main() {
    ...
    let matches = App::new(crate_name!()).about(crate_description!())
        ...
        .arg(
            Arg::with_name("evm_state_rpc_port")
                ...
                .validator(vaempire_validator::port_validator)
        ...
        .arg(
            Arg::with_name("dynamic_port_range")
                ...
                .validator(vaempire_validator::port_range_validator)
        ...
        .arg(
            Arg::with_name("account_indexes")
                ...
                .possible_values(&[
                    ...
                    "spl-token-owner",
                    "spl-token-mint",
                    "vaempire-accounts-storages",
                    "vaempire-accounts-owners",
                    "vaempire-accounts-operationals",
                    "vaempire-relying-party-owners",
                ])
                .value_name("INDEX")
    ...
    let logfile = {
        let logfile = matches
            .value_of("logfile")
            .map(|s| s.into())
            .unwrap_or_else(|| format!("vaempire-validator-{}.log", identity_keypair.pubkey()));
...
fn process_account_indexes(matches: &ArgMatches) -> AccountSecondaryIndexes {
    let account_indexes: HashSet<AccountIndex> = matches
        ...
        .map(|value| match value {
            ...
            "vaempire-accounts-storages" => AccountIndex::VaempireAccountStorage,
            "vaempire-accounts-owners" => AccountIndex::VaempireAccountOwner,
            "vaempire-accounts-operationals" => AccountIndex::VaempireAccountOperational,
            "vaempire-relying-party-owners" => AccountIndex::VaempireRelyingOwner,

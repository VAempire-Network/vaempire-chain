...
impl AccountsDb {
        ...
        A: Default,
    {
        let key = match &index_key {
            ...
            IndexKey::VaempireAccountStorage(key) => key,
            IndexKey::VaempireAccountOwner(key) => key,
            IndexKey::VaempireAccountOperational(key) => key,
            IndexKey::VaempireRelyingOwner(key) => key,
        };

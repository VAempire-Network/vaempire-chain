...
pub enum RpcRequest {
    ...
    /// Vaempire Account scope
    GetVaempireAccountsByOperationalKey,
    GetVaempireAccountsByOwnerKey,
    GetVaempireRelyingPartiesByOwnerKey,
...
impl fmt::Display for RpcRequest {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        let method = match self {
            ...
            RpcRequest::GetVaempireAccountsByOperationalKey => "getVaempireAccountsByOperationalKey",
            RpcRequest::GetVaempireAccountsByOwnerKey => "getVaempireAccountsByOwnerKey",
            RpcRequest::GetVaempireRelyingPartiesByOwnerKey => "getVaempireRelyingPartiesByOwnerKey",
